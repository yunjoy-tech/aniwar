...
def send_msg(_url, _msg,_state,_title):
    """
    :param _url:
    :param _msg:
    :return:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--title', type=str, default=None, required=True, help="标题")
    ...
    print(send_msg(url, msg,args.state,args.title))
