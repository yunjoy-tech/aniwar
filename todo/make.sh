...
#GIT_TERMINAL_PROMPT=1 go get -u  github.com/yunjoy-tech/musae@main
...
echo ${GoVersion}
LDFLAGS=-ldflags="-X github.com/yunjoy-tech/musae/global.APP_VERSION=${VERSION}|${DOCKER_TAG}|${BuildVersion}|${BuildTime} -X github.com/yunjoy-tech/musae/global.VERSION=${VERSION}"
if [[ $2 == "release" ]]; then
  LDFLAGS=-ldflags="-X github.com/yunjoy-tech/musae/global.APP_VERSION=${VERSION}|${DOCKER_TAG}|${BuildVersion}|${BuildTime} -X github.com/yunjoy-tech/musae/global.VERSION=${VERSION} -w"
fi
