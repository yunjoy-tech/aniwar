...
::set LDFLAGS="-ldflags=-X gitee.com/aniwar2/musae/global.APP_VERSION=DEBUG|"%date:~0,4%-%date:~5,2%-%date:~8,2%-%hour%-%time:~3,2%-%time:~6,2%
set LDFLAGS="-ldflags=-X gitee.com/aniwar2/musae/global.APP_VERSION=DEBUG"
