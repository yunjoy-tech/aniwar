...
func NewAllianceMessage(allianceId int64, message *cmd.BroadMessage) *AllianceMessage {
...
func NewAllianceHandler(actor *AllianceActor) *AllianceHandler {
	...
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_CreateAllianceReq), h.CreateAllianceReq)             // 创建联盟
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_JoinAllianceReq), h.JoinAllianceReq)                 // 加入联盟
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_ChangeAllianceInfoReq), h.ChangeAllianceInfoReq)     // 修改联盟信息
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_AllianceApplyHandleReq), h.AllianceApplyHandleReq)   // 审核申请
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_ChangeMemberPositionReq), h.ChangeMemberPositionReq) // 修改职位
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_GetAllianceLogReq), h.GetAllianceLogReq)             // 拉取日志
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_ExitAllianceReq), h.ExitAllianceReq)                 // 退出（踢出）联盟

	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_GetAllianceInfoReq), h.GetAllianceInfoReq)           // 拉取联盟基本信息
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_AddContributeReq), h.AddContributeReq)               // 增加联盟贡献度
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_BindMemberGateTopicReq), h.BindMemberGateTopicReq)   // 绑定/解绑成员Topic
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_SendMessage2AllianceReq), h.SendMessage2AllianceReq) // 向联盟发送消息
	actor.RegisterProtoHandler(int32(cmd.Protocols_PS2S_GetAllianceMessageReq), h.GetAllianceMessageReq)     // 获取联盟聊天消息
...
func (h *AllianceHandler) SetDBData(dbData proto.Message) error {
	if dbVal, ok := dbData.(*cmd.PServerAllianceInfo); ok {
		h.actor.Data = dbVal
	} else {
...
func (h *AllianceHandler) GetAllianceInfoReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	return &cmd.S2S_GetAllianceInfoRes{Info: h.toCommonAllianceInfo(h.actor.Data)}, nil, int32(cmd.ErrorCode_Success)
}

func (h *AllianceHandler) MessageWrite2Channel(allianceId int64, message *cmd.BroadMessage) {
...
func (h *AllianceHandler) AddContributeReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_AddContributeReq
	...
	return &cmd.S2S_AddContributeRes{}, nil, int32(cmd.ErrorCode_Success)
}

func (h *AllianceHandler) handleAddContribute(addType, addValue int32, targetId uint64) (error, int32) {
	if addType == 1 {
		h.addAllianceLog(targetId, cmd.AllianceLogType_LogType_Sign)
	}
	if addValue == 0 {
		if err := h.SaveDB(true); err != nil {
			return err, int32(cmd.ErrorCode_SaveDBError)
		}
		return nil, 0
	}
	// 是否领取过签到奖励
...
func (h *AllianceHandler) SendMessage2AllianceReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_SendMessage2AllianceReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	if !h.IsAllianceMember(req.Message.FromRoleId) {
		return nil, errors.New("member is not found"), int32(cmd.ErrorCode_Member_not_found)
	}
	//存储联盟消息
	data := h.GetAllianceData()
	...
	//向联盟在想成员推送消息
	h.BroadcastMessages(req.GetMessage(), req.Message.FromRoleId, cmd.ChatChannel_Channel_alliance)

	return &cmd.S2S_SendMessage2AllianceRes{}, nil, int32(cmd.ErrorCode_Success)
...
func (h *AllianceHandler) GetAllianceMessageReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_GetAllianceMessageReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	res := &cmd.S2S_GetAllianceMessageRes{
		Message: message,
	}
...
func (h *AllianceHandler) BindMemberGateTopicReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_BindMemberGateTopicReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	return &cmd.S2S_BindMemberGateTopicRes{}, nil, int32(cmd.ErrorCode_Success)
}
...
func (h *AllianceHandler) ExitAllianceReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_ExitAllianceReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	if req.ExitType == 1 {
		...
		if !h.checkPermission(in.RoleId, MEMBER_PERMISSION_KICKOUT) {
			return nil, fmt.Errorf("member permission illegal"), int32(cmd.ErrorCode_Member_permission_illegal)
		}
		// 是否级别足够
		mine := data.Member[in.RoleId]
		target := data.Member[req.TargetId]
		if mine == nil || target == nil {
			return nil, fmt.Errorf("member not found"), int32(cmd.ErrorCode_Member_not_found)
		}
		if target.Position >= mine.Position {
			return nil, fmt.Errorf("illegal operation"), int32(cmd.ErrorCode_Member_permission_illegal)
		}

		// 踢出
		h.exitAlliance(req.TargetId, req.ExitType, in.RoleId, in.GetUserId())
	} else {
		return nil, fmt.Errorf("unrealized exit type %d", req.ExitType), int32(cmd.ErrorCode_UnrealizedTypeError)
	}
...
func (h *AllianceHandler) GetAllianceLogReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_GetAllianceLogReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
...
func (h *AllianceHandler) ChangeMemberPositionReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	...
	if target.Position == req.PositionId {
		return &cmd.S2S_ChangeMemberPositionRes{}, nil, 0
	}

	// 职位有效性判定
	if req.PositionId <= int32(cmd.MemberPositionType_None) || req.PositionId >= int32(cmd.MemberPositionType_Max) {
		return nil, fmt.Errorf("position illegal"), int32(cmd.ErrorCode_ParamError)
	}
	...
	var f bool
	var typ cmd.AllianceLogType
	if req.PositionId == int32(cmd.MemberPositionType_Leader) {
		// 委任头目
		if !h.checkPermission(in.RoleId, MEMBER_PERMISSION_ABDICATE) {
			return nil, fmt.Errorf("member permission illegal"), int32(cmd.ErrorCode_Member_permission_illegal)
		}
		if mine.Position != int32(cmd.MemberPositionType_Leader) {
			return nil, fmt.Errorf("current member not leader"), int32(cmd.ErrorCode_IllegalOperationError)
		}
		changeLeader(data, req.TargetId, data.Base.LeaderId)
		typ = cmd.AllianceLogType_LogType_Promote_Position
		f = true
	} else {
		// 检查职位数量是否足够
		if !h.checkPositionNum(req.PositionId) {
			return nil, fmt.Errorf("position num not enough"), int32(cmd.ErrorCode_Position_not_enough)
		}
		// 职位升降调动
		...
		if oldPosition < req.PositionId {
			...
			// 降职了
			typ = cmd.AllianceLogType_LogType_Reduce_Position
		}
	}
	// 记录日志
	...
	info := &cmd.PCommonAllianceInfo{
		Base:    h.toAllianceBaseInfo(data.Base),
		Members: h.toCommonAllianceMembers(data.Member),
	}
	return &cmd.S2S_ChangeMemberPositionRes{Info: info}, nil, 0
}

func (h *AllianceHandler) AllianceApplyHandleReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_AllianceApplyHandleReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	member := make([]*cmd.PCommonAllianceMember, 0)
	if req.IsAgree {
		// 同意
		for id, ts := range roleIds {
			...
			// 是否已经在其他联盟
			reqMsg := &cmd.S2S_CheckInAllianceReq{}
			rspMsg := &cmd.S2S_CheckInAllianceRes{}
			if err, _ = h.actor.Srv.CallUserActor(true, id, int32(cmd.Protocols_PS2S_CheckInAllianceReq), reqMsg, rspMsg); err != nil {
				h.Error(err)
				continue
			}
			// 已经有联盟了
			...
			// 通知到玩家
			reqMsg2 := &cmd.S2S_JoinAllianceNtf{Alliance: h.toCommonAllianceInfo(data)}
			rspMsg2 := &cmd.S2S_JoinAllianceNtf{}
			if err, _ = h.actor.Srv.CallUserActor(true, id, int32(cmd.Protocols_PS2S_JoinAllianceNtf), reqMsg2, rspMsg2); err != nil {
				h.Error(err)
				continue
			}
			// 加入
			m := h.joinAlliance(id, int32(cmd.MemberPositionType_Member), in)
	...
	var result *cmd.ApplyResultItem
	if ftype == 1 {
		result = &cmd.ApplyResultItem{FType: ftype, RoleIds: success}
	} else if ftype == 2 {
		result = &cmd.ApplyResultItem{FType: ftype, RoleIds: unhandles}
	} else if ftype == 3 {
		result = &cmd.ApplyResultItem{FType: ftype, RoleIds: delIds}
	} else if ftype == 4 {
		result = &cmd.ApplyResultItem{FType: ftype, RoleIds: outdate}
	}

	res := &cmd.S2S_AllianceApplyHandleRes{
		Result:  result,
		Members: member,
		Base:    h.toAllianceBaseInfo(data.Base),
	}
...
func (h *AllianceHandler) ChangeAllianceInfoReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	var req cmd.S2S_ChangeAllianceInfoReq
	err := in.UnmarshalData(&req)
	if err != nil {
		return nil, err, int32(cmd.ErrorCode_DeSerializeError)
	}
	...
	return &cmd.S2S_ChangeAllianceInfoRes{Info: info}, nil, 0
}
...
func (h *AllianceHandler) JoinAllianceReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	...
	if _, ok := data.Examines[in.RoleId]; ok {
		...
		return &cmd.S2S_JoinAllianceRes{ErrCode: int32(cmd.ErrorCode_Had_apply_alliance)}, nil, 0
	}
	...
	if len(data.Examines) >= limit {
		...
		return &cmd.S2S_JoinAllianceRes{ErrCode: int32(cmd.ErrorCode_Alliance_apply_limit)}, nil, 0
	}
...
func (h *AllianceHandler) CreateAllianceReq(ctx context.Context, in *base.ProtoMsg) (proto.Message, error, int32) {
	...
	h.actor.Data = &cmd.PServerAllianceInfo{
		Base: &cmd.PServerAllianceBaseInfo{
			Id:             allianceId,
			Name:           req.Name,
			Profile:        req.Profile,
			Notice:         "",
		...
		Member:   make(map[uint64]*cmd.PAllianceMember),
		Log:      make([]*cmd.PCommonAllianceLog, 0),
		Examines: make(map[uint64]int64),
	}
	h.joinAlliance(in.RoleId, int32(cmd.MemberPositionType_Leader), in)
	...
	return &cmd.S2S_CreateAllianceRes{Info: h.toCommonAllianceInfo(h.actor.Data)}, nil, int32(cmd.ErrorCode_Success)
}
...
func (h *AllianceHandler) BroadcastMessages(message *cmd.BroadMessage, fromRoleId uint64, channelId cmd.ChatChannel) {
...
func (h *AllianceHandler) NotifyMem(formRoleId, toRoleId uint64, message *cmd.BroadMessage, channelId cmd.ChatChannel) error {
	baseInfo, err := h.actor.getRoleBaseDataByRoleId(formRoleId)
	if err != nil {
		return err
	}
	notify := &cmd.LS2C_NotifyPrivateMessage{
		ChannelId: channelId,
		Message:   message,
