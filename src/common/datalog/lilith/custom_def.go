...
//	BuildingId int64  `json:"building_id"`           //建筑id
//	Lv         int32  `json:"lv"`                    //建筑等级
//	BeforeList string `json:"before_list,omitempty"` //刷新前的清单列表 []*pb.PPlayerCampTraderList
//	AfterList  string `json:"after_list,omitempty"`  //刷新后的清单列表 []*pb.PPlayerCampTraderList
// }
//
...
//	Costs    string `json:"costs,omitempty"`  //消耗物 []*pb.KeyValueItem
...
//	*PropertyFieldInfo
//	BattleResult int64  `json:"battle_result"`          // 战斗结果 pb.BattleResult
//	LevelId      int32  `json:"level_id"`               // 关卡id
//	BattleCards  string `json:"battle_cards,omitempty"` // 卡牌信息 []*pb.PPlayerBattleCard
//	Foods        string `json:"foods,omitempty"`        // 食物itemId列表 []*int32
//	/*	PlayerLevelData string `json:"player_level_data,omitempty"` // 关卡数据 *pb.PlayerLevelData*/
...
//	BattleCards   string `json:"battle_cards,omitempty"` // 卡牌信息 []*pb.PPlayerBattleCard
//	Foods         string `json:"foods,omitempty"`        // 食物itemId列表 []*int32
//	CostFoods     string `json:"cost_foods,omitempty"`   // 消耗食物信息 []*pb.KeyValueItem
// }
//
// // 大地图-事件处理
...
//	ShopGoodsInfo string `json:"goods_ids,omitempty"` // 商品ids []*pb.ShopGoodsInfo
...
//	GoodsInfo string `json:"goods_info"` // 商品信息 *pb.ShopGoodsInfo
// }
//
// // 玩家体力变化
