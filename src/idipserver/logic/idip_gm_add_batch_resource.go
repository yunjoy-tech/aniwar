...
// 请求参数结构
type AddBatchResourceReq struct {
	ReqType  string        `json:"type"`     // 固定值 “gm_add_batch_resource”
...
// AddBatchResource 增加批量资源
func (s *IDIPServer) AddBatchResource(out *common.Content, reqJson []byte) {
	// 解析数据
